...
def simplemap(species):
       ...
       col_x_hist,col_y_hist = m(col_x_hist,col_y_hist)
       m.plot(col_x_hist, col_y_hist, marker='^',color='#f1a340', markersize=3, zorder=27, latlon=False,
       ...
       col_x_surplus,col_y_surplus = m(col_x_surplus,col_y_surplus)
       m.plot(col_x_surplus, col_y_surplus, marker='.',color='#998ec3', markersize=7, zorder=28, latlon=False,
           linestyle='None', markeredgewidth=.2, markeredgecolor='black', alpha=.8)
       ...
       col_x_mscodes,col_y_mscodes = m(col_x_mscodes,col_y_mscodes)
       m.plot(col_x_mscodes, col_y_mscodes, marker='.',color='#2ca25f', markersize=7, zorder=29, latlon=False,
           linestyle='None', markeredgewidth=.2, markeredgecolor='black', alpha=.8)
